<template>
  <div class="background">
    ...
    @success="isShowDialogs3 = true;" @giveup="isGiveUp = true; reset();">
    </RecaptchaDialogs>
    <!-- ステージ3 (ベーグルと犬) -->
    ...
    @success="isShowDialogs4 = true;" @giveup="isGiveUp = true">
    </RecaptchaDialogs>
    <!-- ステージ4 (ネコとアイス) -->
    ...
    image-name5='cat3.jpg' image-name6='ice3.jpg' image-name7='cat4.jpg' image-name8='ice4.jpg' image-name9='cat5.jpg'
    @success="isShowDialogs5 = true;" @giveup="isGiveUp = true">
    </RecaptchaDialogs>
    <!-- ステージ5 (チワワとマフィン) -->
    ...
    image-name5='chihuahua3.jpg' image-name6='muffin3.jpg' image-name7='chihuahua4.jpg' image-name8='muffin4.jpg' image-name9='chihuahua5.jpg'
    @success="isShowDialogs6 = true;" @giveup="isGiveUp = true">
    </RecaptchaDialogs>
    <!-- ステージ6 (モップとシープドッグ) -->
    ...
    @success="isShowDialogs7 = true;" @giveup="isGiveUp = true">
    </RecaptchaDialogs>
    <!-- ステージ7 (ふじとその他のりんご) -->
    ...
    @success="isShowDialogs8 = true;" @giveup="isGiveUp = true">
    </RecaptchaDialogs>
    <!-- ステージ8 (あまおうとその他のいちご) -->
    ...
    @success="isShowDialogs9 = true;" @giveup="isGiveUp = true">
    </RecaptchaDialogs>
    ...
    @success="isShowDialogs10 = true; submit(); dataCount();" @giveup="isGiveUp = true">
    </RecaptchaDialogs>
    ...
    @success="isFinished = true; reset();" @giveup="isGiveUp = true">
    </RecaptchaDialogs>
...
import GiveUpDialogs from '~/components/GiveUpDialogs.vue'
